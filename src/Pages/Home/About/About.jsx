...
//             <div className="max-w-screen-xl mx-auto grid lg:grid-cols-2 items-center gap-12">
//                 {/* Images Section */}
//                 <div className="relative">
//                     <img
//                         src={aboutImg}
//                         alt="Person working in the workshop"
//                         className="w-full max-w-md rounded-xl shadow-xl mx-auto"
//                     />
//                     <img
//                         src={parts}
//                         alt="Mechanical parts"
//                         className="w-40 md:w-48 rounded-xl border-4 border-white shadow-lg absolute -right-6 -bottom-10"
//                         style={{ zIndex: 10 }}
//                     />
//                 </div>
...
//                 {/* Text Section */}
//                 <div>
//                     <h4 className="text-orange-700 font-semibold uppercase tracking-wide mb-3">About Us</h4>
//                     <h2 className="text-4xl md:text-5xl font-bold leading-tight mb-6">
//                         We are highly qualified <br /> with years of experience
//                     </h2>
//                     <p className="text-gray-600 mb-4">
//                         With a strong background in our field, we bring reliable expertise and trustworthy service. Our team is committed to excellence and innovation in every project.
//                     </p>
//                     <p className="text-gray-600 mb-6">
//                         We ensure quality and consistency by using modern technologies and a customer-focused approach that delivers lasting results.
//                     </p>
//                     <button className="btn btn-soft  bg-[#FF3811]">Get Started</button>
//                 </div>
//             </div>
//         </section>
//     );
